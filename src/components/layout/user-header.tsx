...
const topBarInfo = [
  {
    text: "202, Planet Apartment, Jaywant Nagar, Omkar Nagar, Nagpur, Maharashtra 440027",
    icon: MapPin,
  },
  {
    text: "+91 9890917528 | 9960266198 | 7887755544",
    icon: Phone,
    isLink: true,
    href: "tel:+919890917528",
  },
...
const servicesLinks = [
  {
    ...
    learnMore: "Learn more about Software Solutions",
  },
  {
    href: "/conference",
  ...
  },
  {
    ...
    learnMore: "Learn more about Author Services",
  },
  {
    href: "/services/patent-consultancy",
    label: "Patent Drafting Services",
    learnMore: "Learn more about Patent Drafting",
  },
];
...
export default function UserHeader() {
  ...
  const NavLink = ({
    ...
    link: { href: string; label: string; dropdown?: { href: string; label: string }[] };
  }) => {
    if (link.dropdown) {
      return (
        <DropdownMenu>
    ...
    return (
      <Link
        href={link.href}
        className={cn("px-3 py-2 rounded-md text-base text-foreground")}
      >
        {link.label}
      </Link>
    );
      ...
      <div className="container mx-auto flex h-20 items-center justify-between px-4">
        <div className="flex items-center">
          <Link href="/" className="mr-6 flex items-center space-x-2">
            ...
            <span className="sr-only">Researcher Connect Home</span>
          </Link>
        ...
        <div className="flex items-center">
          <div className="hidden md:flex items-center">
            <Button
              asChild
              variant="outline"
              className="rounded-full bg-white border-gray-200 hover:bg-gray-50 text-foreground px-6"
            >
              ...
              <div className="py-4">
                ...
                <div className="p-4 border-t mt-4 space-y-2">
                  <Button
                    asChild
                    variant="outline"
                    className="w-full rounded-full bg-white border-gray-200 hover:bg-gray-50 text-foreground px-6"
                  >
