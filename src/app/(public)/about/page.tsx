        ...
        <div className="w-full py-12 md:py-24 lg:py-32 bg-secondary/30">
          <div className="container px-4 md:px-6 space-y-16">
            ...
            <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl font-bold text-center mb-12">Company Overview</h2>
                <div className="space-y-8 text-muted-foreground">
                    ...
                    <div className="border-l-4 border-primary pl-6 py-4 bg-background rounded-r-lg">
