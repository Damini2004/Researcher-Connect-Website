  ...
  return (
    <div className="container py-12 md:py-24 px-4 md:px-6">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Digital Library</h1>
        <p className="mt-4 text-lg text-muted-foreground">Browse through our extensive collection of research published with JournalEdge.</p>
        <div className="relative mt-6 max-w-lg mx-auto">
          <Input placeholder="Search by title, author, or keyword..." className="pl-10 h-12" />
